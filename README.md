...
### JobReach AI - LLM-Powered Job Outreach Generator
Fine-tuned Llama 3.1 8B with LoRA on 4,091 synthetic training examples, achieving 40% improvement in message relevance and 60% reduction in generic phrasing. Built production FastAPI backend deployed on Modal serverless GPU with Gradio frontend.

### Safety Mapper - Intelligent Community Safety Platform
Developed Python Flask application with Google Cloud Firestore integration and Gemini AI for real-time incident reporting. Implemented sophisticated route safety analysis evaluating transportation paths against incident data with multi-modal risk assessment.

### Caption Creator Pro - Hugging Face Hackathon Winner
Architected high-performance multimodal AI platform integrating SambaNova Llama models with multi-provider translation system, achieving sub-2.1s caption generation and 40% performance improvement over industry standards.

---

## 📚 Education & Certifications

**Master of Science in Computer Science** (Secondary Major: AI)
Florida Atlantic University, Boca Raton, FL | GPA: 3.96/4.0 | Aug 2023 - Dec 2024

**Bachelor of Technology in Computer Science** (Honor's)
SASTRA University, Tamil Nadu | GPA: 3.8/4.0 | June 2019 - June 2023
...
🏅 **Gangal Family Endowed Graduate Scholarship Award** - Awarded to top 1% Computer Science student for academic excellence and TA contributions (only one recipient selected department-wide)

🥇 **Hugging Face Hackathon Winner** - Caption Creator Pro project
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/GayathriChilukala)
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)](https://leetcode.com/u/GChilukala1024/)
</div>
